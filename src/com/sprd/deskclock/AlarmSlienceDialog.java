...
public class AlarmSlienceDialog extends DialogFragment {
    ...
    public static AlarmSlienceDialog newInstance(Alarm alarm, TextView textView) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        int defaultValue = Integer.parseInt(Utils.getDefaultSharedPreferences(context)
        ...
        mAutoSilenceDialog.setSingleChoiceItems(
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // mAlarm = Utils.getUpdateAlarm(context, mAlarm);
                        /* @} */
                        ...
                        String autoSilenceTitle = context.getString(R.string.auto_silence_title)
                                + " " + setAutoSilenceTitle;
                        if(mTextView != null){
                            mTextView.setText(autoSilenceTitle);
                        }
