...
class RingtoneLoader extends AsyncTaskLoader<List<ItemAdapter.ItemHolder<Uri>>> {
    ...
    public List<ItemAdapter.ItemHolder<Uri>> loadInBackground() {
        ...
        /* UNISOC: Modify for bug1172408 1186640 Monkey crash because of the mCustomRingtones object are null, reacquire the object mCustomRingtones@{ */
        if (null == mCustomRingtones) {
            mCustomRingtones = DataModel.getDataModel().getCustomRingtonesUnderException();
        }
        /* @} */
