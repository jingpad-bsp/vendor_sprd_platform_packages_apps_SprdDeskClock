...
public class RingtonePickerActivity extends BaseActivity
    ...
    /* UNISOC: Modify for bug 1195414 Key to an instance state value indicating default ringtone name.@{ */
    private static final String DEFAULT_RINGTONE_TITLE_STRING = "default_ringtone_title_string";
    ...
    /* UNISOC: Modify for bug 1195414 @{ */
    private String mDefaultRingtoneTitleString;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOptionsMenuManager = new OptionsMenuManager(this);
        ...
        if (savedInstanceState != null) {
            /* UNISOC: Modify for bug 1195414 @{ */
            mDefaultRingtoneTitleString = savedInstanceState.getString(DEFAULT_RINGTONE_TITLE_STRING);
            /* @} */
        ...
        /* UNISOC: Modify for bug 1195414 @{ */
        if (context.getString(R.string.alarm_sound).equals(context.getString(titleResourceId))) {
            mNameString =context.getString(R.string.default_alarm_ringtone_title);
        } else {
            mNameString =context.getString(R.string.default_timer_ringtone_title);
        }
        if ( null != mDefaultRingtoneTitleString && !mNameString.equals(mDefaultRingtoneTitleString)) {
            getLoaderManager().restartLoader(0 /* id */, null /* args */, this /* callback */);
        }
        /* @} */
            ...
            if (mAlarmId != -1) {
                ...
                new AsyncTask<Void, Void, Alarm>() {
                    ...
                    protected void onPostExecute(Alarm alarm) {
                        ...
                        /* UNISOC: Modify for bug1168180 1178732 @{ */
                        if (alarm != null) {
                            DataModel.getDataModel().setDefaultAlarmRingtoneUri(alarm.alert == null ? Alarm.NO_RINGTONE_URI : alarm.alert);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        /* UNISOC: Modify for bug 1195414 @{ */
        outState.putString(DEFAULT_RINGTONE_TITLE_STRING, mNameString);
        /* @} */
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        mOptionsMenuManager.createOptionsMenu(menu, getMenuInflater());
        return true;
    }

    @Override
    public boolean onPrepareOptionsMenu(Menu menu) {
        mOptionsMenuManager.prepareShowMenu(menu);
        return true;
    }

    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        if (mOptionsMenuManager.handleMenuItemClick(item)) {
            return true;
        }
    ...
    private RingtoneHolder getRingtoneHolder(Uri uri) {
        /* UNISOC: Modify for bug 1143876 {@ */
        if (null != mRingtoneAdapter.getItems()) {
