...
public final class Screensaver extends DreamService {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        /* UNISOC: Modify for bug1164380 Ignore the configuration change if no window exists @{ */
        if (getWindow() != null) {
            stopPositionUpdater();
            layoutClockSaver();
            startPositionUpdater();
    ...
    private void layoutClockSaver() {
        ...
        mMainClockView.setAlpha(0);  //UNISOC: Modify for bug11172641
