...
class StopwatchNotificationBuilder {
    ...
    public Notification build(Context context, NotificationModel nm, Stopwatch stopwatch) {
        ...
        final Resources res = context.getResources();
         /* SPRD modify for bug 711374,1113212 {@ */
        String arr[] = new String[2];
        arr[0] = String.valueOf(SystemClock.elapsedRealtime());
        arr[1] = String.valueOf(stopwatch.getTotalTime());
        String base = arr[0] + "," + arr[1];
        final RemoteViews content = new RemoteViews(pname, R.layout.chronometer_notif_content);
        content.setChronometerNoDelay(R.id.chronometer, base, null, running);
        /* @} */
        ...
        /*UNISOC: Modify for bug 1170030 @{*/
        final Builder notification = new NotificationCompat.Builder(context)
                .setLocalOnly(true)
                .setOngoing(running)
                .setCustomContentView(content)
                .setContentTitle(context.getString(R.string.menu_stopwatch))
        ...
        NotificationChannelManager.applyChannel(notification, context, Channel.STOPWATCH_NOTIFICATION_CHANNEL);
        /*}@*/
        if (Utils.isNOrLater()) {
