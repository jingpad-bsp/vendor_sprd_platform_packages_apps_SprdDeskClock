...
final class TimerModel {
    ...
    /* SPRD: bug 612493 change Time Alert interface @{ */
    private String action = "com.android.gallery3d.app.MovieActivity.onPause";

    private static final String TAG = "TimerModel";

    private Timer isLiveTime;
    ...
    void expireTimer(Service service, Timer timer) {
        ...
        /* SPRD: bug 612493 change Time Alert interface @{ */
        if (!isLiveMoveTopActivity(mContext)){
            ...
            mReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    /* UNISOC: modify for Bug 1174307 @{ */
                    if (isLiveTime != null && isLiveTime.expire() != null){
                        Log.d(TAG, "onReceive:" + isLiveTime.expire());
                        updateTimer(isLiveTime.expire());
                        Intent timersAlert = new Intent(context, ExpiredTimersActivity.class);
    ...
    //Bug 612493 add unregisterReceiver method for streaming case
