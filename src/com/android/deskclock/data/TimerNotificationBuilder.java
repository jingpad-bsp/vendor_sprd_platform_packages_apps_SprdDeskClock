...
class TimerNotificationBuilder {
    ...
    public Notification build(Context context, NotificationModel nm, List<Timer> unexpired) {
        ...
        if (count == 1) {
            if (running) {
                ...
                /*UNISOC: Modify for bug 1125926 @{*/
                stateText = TextUtils.isEmpty(timer.getLabel()) ? res.getString(R.string.timer_paused) : timer.getLabel();
                /* @} */
        ...
        NotificationChannelManager.applyChannel(notification, context, Channel.TIMER_NOTIFICATION_CHANNEL);
        /*}@*/
    ...
    Notification buildHeadsUp(Context context, List<Timer> expired) {
        ...
        final Builder notification = new NotificationCompat.Builder(context)
                ...
                .setColor(ContextCompat.getColor(context, R.color.default_background));
        /*UNISOC: Modify for bug 1106733 @{*/
        NotificationChannelManager.applyChannel(notification, context, Channel.TIMER_EXPIRED_NOTIFICATION_CHANNEL);
        /*}@*/
