...
public class StopwatchLandscapeLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // Stopwatch timer consumes the half width of container and the laps list consumes the remaining half if it exists
        /* UNISOC: Modify for bug1179384  @{ */
        final int stopwatchWidth = halfWidth;
        /* @} */
