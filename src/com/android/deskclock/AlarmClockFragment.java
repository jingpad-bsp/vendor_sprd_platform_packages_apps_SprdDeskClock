...
public  class AlarmClockFragment extends DeskClockFragment implements
        ...
        ScrollHandler,
        TimePickerDialogFragment.OnTimeSetListener, ShowAutoSilenceDialogListener, ShowRepeatAlarmDialogListener {
    ...
    private void scrollToAlarm(long alarmId) {
        ...
        if (alarmPosition >= 0) {
            ...
            SnackbarManager.show(Snackbar.make(mMainLayout, R.string
                    .missed_alarm_has_been_deleted, Snackbar.LENGTH_LONG), getActivity());
        }
    }
