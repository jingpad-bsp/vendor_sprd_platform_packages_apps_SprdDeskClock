...
public class ScreensaverActivity extends BaseActivity {
    ...
    /* UNISOC: modify for bug 1110465 @{ */
    private static boolean mIsInteractionAllowed = false;
    /* @} */
    ...
    private final class InteractionListener implements View.OnSystemUiVisibilityChangeListener {
        ...
        public void onSystemUiVisibilityChange(int visibility) {
            ...
            if ((visibility & View.SYSTEM_UI_FLAG_HIDE_NAVIGATION) == 0 && mIsInteractionAllowed) {
                // We want the screen saver to exit upon user interaction.
                finish();
            }
