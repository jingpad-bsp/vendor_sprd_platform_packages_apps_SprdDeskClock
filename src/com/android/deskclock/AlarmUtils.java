...
public class AlarmUtils {
    ...
    public static void popAlarmSetSnackbar(View snackbarAnchor, long alarmTime, Context context) {
        final long alarmTimeDelta = alarmTime - System.currentTimeMillis();
        final String text = formatElapsedTimeUntilAlarm(
                snackbarAnchor.getContext(), alarmTimeDelta);
        SnackbarManager.show(Snackbar.make(snackbarAnchor, text, Snackbar.LENGTH_SHORT), context);
