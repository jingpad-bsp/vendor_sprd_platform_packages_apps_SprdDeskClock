...
public final class AlarmUpdateHandler {
    ...
    // SPRD: bug 473507 add auto silences for each alarm    48
    private boolean mUndoAlarm = false;
    // For undo
    private Alarm mDeletedAlarm;
    public static boolean mIsAddAlarm = false; //UNISOC: modify for bug 1106945
        ...
        final AsyncTask<Void, Void, AlarmInstance> updateTask =
                new AsyncTask<Void, Void, AlarmInstance>() {
                    ...
                    protected AlarmInstance doInBackground(Void... parameters) {
                        mIsAddAlarm= false; //UNISOC: modify for bug 1106945
                        if (alarm != null) {
                    ...
                    protected void onPostExecute(AlarmInstance instance) {
                        if (instance != null) {
                            ...
                            AlarmUtils.popAlarmSetSnackbar(
                                    mSnackbarAnchor, instance.getAlarmTime().getTimeInMillis(), mAppContext);
                        }
                    }
                };
        updateTask.execute();
    ...
    public void showPredismissToast(AlarmInstance instance) {
        ...
        // UNISOC: Modify for bug 1392012
        SnackbarManager.show(Snackbar.make(mSnackbarAnchor, text, Snackbar.LENGTH_SHORT), mAppContext);
    }
    ...
    private void showUndoBar() {
        ...
        // UNISOC: Modify for bug 1392012
        SnackbarManager.show(snackbar, mAppContext);
    }
