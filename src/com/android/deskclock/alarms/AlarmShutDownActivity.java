...
public class AlarmShutDownActivity extends Activity implements OnClickListener {
    ...
    private PowerManagerEx mAbsPowerManager;
            ...
            if (!mAlarmHandled) {
                switch (action) {
                    ...
                    case AlarmService.ALARM_DONE_ACTION:
                        ...
                        finish();
                        break;
                    /*UNISOC: Modify for bug 1136383 @{*/
                    case Intent.ACTION_CLOSE_SYSTEM_DIALOGS:
                        if ("homekey".equals(intent.getStringExtra("reason"))) {
                            AlarmStateManager.setMissedState(getApplicationContext(),mAlarmInstance);
                        }
                        break;
                    /* @} */
                    default:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAbsPowerManager = new PowerManagerEx(this);
    ...
    private void snooze() {
        ...
        mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                mAbsPowerManager.shutdownForAlarm();
            }
        }, ALERT_DISMISS_DELAY_MILLIS);
    }
