...
public final class SnackbarManager {
    ...
    public static void show(Snackbar snackbar, Context context) {
        sSnackbar = new WeakReference<>(snackbar);

        if (CitySelectionActivity.getDeviceNaturalOrientation(context) == Configuration.ORIENTATION_LANDSCAPE) {
